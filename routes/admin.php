...
Route::middleware(['auth', 'role:admin_lembaga,operator,pengajar'])->group(function () {
    ...
    Route::get('recap/print-exam-result', [\App\Http\Controllers\Admin\RecapController::class, 'printExamResult'])->name('admin.recap.print_exam_result');
    ...
    Route::get('recap/print-item-analysis', [\App\Http\Controllers\Admin\RecapController::class, 'printItemAnalysis'])->name('admin.recap.print_item_analysis');
    Route::get('recap/attempt/{id}', [\App\Http\Controllers\Admin\RecapController::class, 'showAttempt'])->name('admin.recap.show_attempt');
