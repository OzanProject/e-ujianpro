                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 pr-md-5 border-right border-light">
                             <div class="d-flex justify-content-between align-items-center mb-4">
                                <h6 class="text-secondary font-weight-bold text-uppercase text-xs mb-0" style="letter-spacing: 1px;">Informasi Dasar</h6>
                                <div class="custom-control custom-control-right custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="isActiveSwitch" name="is_active" value="1" {{ $examSession->is_active ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                     <div class="form-group mb-4">
                                        ...
                                        <select name="subject_id" class="form-control custom-select bg-gray-100 text-muted" disabled>
                                        ...
                                        <small class="text-muted"><i class="fas fa-lock mr-1"></i> Mapel tidak dapat diubah</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="4">{{ old('description', $examSession->description) }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="bg-light rounded-lg p-4 border border-light">
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="datetime-local" name="start_time" class="form-control border-left-0" value="{{ old('start_time', $examSession->start_time->format('Y-m-d\TH:i')) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="datetime-local" name="end_time" class="form-control border-left-0" value="{{ old('end_time', $examSession->end_time->format('Y-m-d\TH:i')) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    <label class="font-weight-bold text-dark text-sm">Durasi (Menit) <span class="text-danger">*</span></label>
                                     <div class="input-group">
                                        ...
                                        <input type="number" name="duration" class="form-control border-left-0" value="{{ old('duration', $examSession->duration) }}" min="1" required>
                                    </div>
                                </div>
                            </div>
                        </div>
