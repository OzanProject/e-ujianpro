                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 pr-md-5 border-right border-light">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    @if($examTypes->isEmpty())
                                        <small class="text-danger mt-1 d-block">
                                            Belum ada data Jenis Ujian. <a href="{{ route('admin.exam_type.create') }}"
                                                class="text-danger font-weight-bold" target="_blank">Buat sekarang</a>
                                        </small>
                                    @endif
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <label class="font-weight-bold text-dark text-sm">Mata Pelajaran <span
                                                    class="text-danger">*</span></label>
                                            <select name="subject_id" id="subject_id" class="form-control custom-select"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <select name="exam_package_id" id="exam_package_id"
                                                class="form-control custom-select">
                                                <option value="">-- Acak / Semua --</option>
                                                @foreach($packages as $package)
                                                    <option value="{{ $package->id }}" data-subject="{{ $package->subject_id }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" rows="4"
                                        placeholder="Tuliskan instruksi untuk siswa...">{{ old('description') }}</textarea>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select name="target_kelas" class="form-control custom-select">
                                        ...
                                        <option value="1" {{ old('target_kelas') == '1' ? 'selected' : '' }}>Kelas 1 / I</option>
                                        <option value="2" {{ old('target_kelas') == '2' ? 'selected' : '' }}>Kelas 2 / II</option>
                                        <option value="3" {{ old('target_kelas') == '3' ? 'selected' : '' }}>Kelas 3 / III</option>
                                        <option value="4" {{ old('target_kelas') == '4' ? 'selected' : '' }}>Kelas 4 / IV</option>
                                        <option value="5" {{ old('target_kelas') == '5' ? 'selected' : '' }}>Kelas 5 / V</option>
                                        <option value="6" {{ old('target_kelas') == '6' ? 'selected' : '' }}>Kelas 6 / VI</option>
                                        <option value="7" {{ old('target_kelas') == '7' ? 'selected' : '' }}>Kelas 7 / VII</option>
                                        <option value="8" {{ old('target_kelas') == '8' ? 'selected' : '' }}>Kelas 8 / VIII</option>
                                        <option value="9" {{ old('target_kelas') == '9' ? 'selected' : '' }}>Kelas 9 / IX</option>
                                        <option value="10" {{ old('target_kelas') == '10' ? 'selected' : '' }}>Kelas 10 / X</option>
                                        <option value="11" {{ old('target_kelas') == '11' ? 'selected' : '' }}>Kelas 11 / XI</option>
                                        <option value="12" {{ old('target_kelas') == '12' ? 'selected' : '' }}>Kelas 12 / XII</option>
                                        <option value="13" {{ old('target_kelas') == '13' ? 'selected' : '' }}>Kelas 13 / XIII</option>
                                    </select>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="datetime-local" name="start_time"
                                                class="form-control border-left-0" value="{{ old('start_time') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="duration" class="form-control border-left-0"
                                                value="{{ old('duration', 60) }}" min="1" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-0 mt-4 border-top pt-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="showScoreSwitch"
                                                name="show_score" value="1" checked>
