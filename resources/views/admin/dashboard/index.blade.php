    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm overflow-hidden"
                    ...
                    <div class="card-body p-4 text-white position-relative">
                        <div
                            style="position: absolute; right: -20px; top: -20px; font-size: 150px; opacity: 0.1; transform: rotate(-15deg);">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100 py-2"
                    style="border-radius: 15px; border-left: 5px solid #4e73df;">
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100 py-2"
                    style="border-radius: 15px; border-left: 5px solid #1cc88a;">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100 py-2"
                    style="border-radius: 15px; border-left: 5px solid #36b9cc;">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100 py-2"
                    style="border-radius: 15px; border-left: 5px solid #f6c23e;">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
                ...
                <!-- Quick Actions -->
                <div class="row mb-4">
                    @if($user->role === 'admin_lembaga' || $user->role === 'operator')
                        <div class="col-lg-3 col-6 mb-3">
                            <a href="{{ route('admin.student.create') }}"
                                class="btn btn-white shadow-sm w-100 h-100 py-4 d-flex flex-column align-items-center justify-content-center hover-card"
                                style="border-radius: 15px;">
                                <div class="bg-primary-soft text-primary rounded-circle mb-3 d-flex align-items-center justify-content-center"
                                    style="width: 50px; height: 50px; background: rgba(78, 115, 223, 0.1);">
                    ...
                    @if($user->role === 'pengajar')
                        <div class="col-lg-3 col-6 mb-3">
                            <a href="{{ route('admin.question.create') }}"
                                ...
                                <span class="font-weight-bold text-gray-800 small">Buat Soal</span>
                            </a>
                        </div>
                    @endif
                    ...
                    <div class="col-lg-3 col-6 mb-3">
                        <a href="{{ route('admin.exam_session.create') }}"
                            class="btn btn-white shadow-sm w-100 h-100 py-4 d-flex flex-column align-items-center justify-content-center hover-card"
                            style="border-radius: 15px;">
                            <div class="bg-success-soft text-success rounded-circle mb-3 d-flex align-items-center justify-content-center"
                                style="width: 50px; height: 50px; background: rgba(28, 200, 138, 0.1);">
                    ...
                    @if($user->role === 'admin_lembaga' || $user->role === 'operator')
                        <div class="col-lg-3 col-6 mb-3">
                            <a href="{{ route('admin.report.desk_card.index') }}"
                                class="btn btn-white shadow-sm w-100 h-100 py-4 d-flex flex-column align-items-center justify-content-center hover-card"
                                style="border-radius: 15px;">
                                <div class="bg-info-soft text-info rounded-circle mb-3 d-flex align-items-center justify-content-center"
                                    style="width: 50px; height: 50px; background: rgba(54, 185, 204, 0.1);">
                    ...
                    @if($user->role === 'pengajar')
                        <div class="col-lg-3 col-6 mb-3">
                            <a href="{{ route('admin.exam_package.index') }}"
                                ...
                                <span class="font-weight-bold text-gray-800 small">Paket Soal</span>
                            </a>
                        </div>
                    @endif
                    ...
                    <div class="col-lg-3 col-6 mb-3">
                        <a href="{{ route('admin.recap.exam_result') }}"
                            class="btn btn-white shadow-sm w-100 h-100 py-4 d-flex flex-column align-items-center justify-content-center hover-card"
                            style="border-radius: 15px;">
                            <div class="bg-warning-soft text-warning rounded-circle mb-3 d-flex align-items-center justify-content-center"
                                style="width: 50px; height: 50px; background: rgba(246, 194, 62, 0.1);">
                            ...
                            <div class="mb-3 pb-3 border-bottom {{ $loop->last ? 'border-0 pb-0' : '' }}">
                                ...
                                <div class="small text-gray-600 mb-0">
                                    ...
                                    <a href="#" class="text-primary font-weight-bold" data-toggle="modal"
                                        data-target="#announceModal{{ $announce->id }}">Baca</a>
                                </div>

                                <!-- Modal -->
                                <div class="modal fade" id="announceModal{{ $announce->id }}" tabindex="-1" role="dialog"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content border-0 shadow-lg">
                                            <div class="modal-header border-bottom-0">
                                                <h5 class="modal-title font-weight-bold text-primary">{{ $announce->title }}
                                                </h5>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0 small text-gray-600">
                            ...
                            <li class="mb-2 d-flex justify-content-between">
                                ...
                                <span class="text-success font-weight-bold"><i class="fas fa-circle text-xs mr-1"></i>
                                    Online</span>
                            </li>
                            <li class="mb-2 d-flex justify-content-between">
                                <span>Waktu Server:</span>
                                <span class="font-weight-bold">{{ now()->timezone('Asia/Jakarta')->format('H:i') }}
                                    WIB</span>
                            </li>
                        </ul>
                    </div>
