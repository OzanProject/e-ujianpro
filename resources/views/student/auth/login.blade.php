...
<head>
    ...
    <title>Login Peserta | {{ $globalInstitution->name ?? 'E-Ujian PRO' }}</title>
...
<body class="bg-gray-50 bg-[url('https://s3.ap-southeast-1.amazonaws.com/cdn.e-ujian.com/static-assets/images/bg-auth.png')] bg-cover bg-center min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="text-center">
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Portal Ujian Berbasis Komputer
            </p>
        </div>
    </div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
        <div class="bg-white/90 backdrop-blur-xl py-8 px-6 shadow-2xl sm:rounded-3xl border border-white/60 sm:px-10 relative overflow-hidden">
            ...
            <form class="space-y-6 relative z-10" action="{{ request()->route('subdomain') ? route('institution.student.login', request()->route('subdomain')) : route('student.login') }}" method="POST">
                @csrf

                <div>
                    <label for="nis" class="block text-sm font-semibold text-gray-700 mb-1">NIS / Username</label>
                    <div class="relative">
                        ...
                        <input id="nis" name="nis" type="text" required value="{{ old('nis') }}" class="block w-full pl-10 rounded-xl border-gray-300 bg-gray-50/50 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition duration-200" placeholder="Masukkan NIS Anda" autofocus>
                        @error('nis')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" required class="block w-full pl-10 pr-10 rounded-xl border-gray-300 bg-gray-50/50 py-3 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition duration-200" placeholder="••••••••">
             ...
             <div class="mt-8">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="bg-white px-3 text-gray-500 rounded-full border border-gray-100 shadow-sm">Kembali</span>
                    </div>
                </div>
                 <div class="mt-6 text-center">
                     <a href="{{ request()->route('subdomain') ? route('institution.landing', request()->route('subdomain')) : url('/') }}" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition">
        ...
        <p class="mt-8 text-center text-xs text-gray-500">
            ...
            Aplikasi Ujian Online Aman & Terpercaya.
        </p>
    </div>
