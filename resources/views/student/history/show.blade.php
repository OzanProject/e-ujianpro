...
<div class="row">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                        <b>Nilai Akhir</b> <a class="float-right badge badge-success" style="font-size: 1.2em">{{ number_format($attempt->score, 2) }}</a>
                    </li>
                </ul>
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                {{-- Only show details if allowed (Optional logic could be added here) --}}
